#!/usr/bin/env bash
# ============================================================
#  send_survey_broadcast.sh
#  Envoie l'email questionnaire de satisfaction.
#  Une seule fois par adresse email (pas de doublon).
#
#  Usage:
#    ./send_survey_broadcast.sh
#    ./send_survey_broadcast.sh -u test@example.com
#    ./send_survey_broadcast.sh --force
# ============================================================
set -uo pipefail
...
if not running and total == 0:
    ...
    print("\n  ℹ️  Aucun email à envoyer (toutes les adresses ont déjà reçu le questionnaire).")
    sys.exit(0)
